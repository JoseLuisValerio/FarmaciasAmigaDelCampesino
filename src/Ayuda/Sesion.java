...
/**
 *
 * @author Jose Luis Clase que Recibe LeerSesion para la creación de sesiones
 */
public class Sesion {

    static ArrayList<String> datosSesion = null;
    static ArrayList<Integer> permisosSesion = null;
...
//rebie el usuario , el nombre de usuario  y el tipo para asignar permisos
        ...
        permisosSesion = new ArrayList<Integer>();
